...
export default function Login() {
    ...
    return (
        <>
            ...
            <div className="container mt-5 boxShadow" style={{ backgroundColor: "dark", height: "620px", width: "700px" }}>
                <div className="row">
                    <div className="col">
                ...
                <div className="row mt-3">
                    ...
                    {/* <div className="col-3">
                        <Link to="/auth/loginAccounts" id='forgot' style={{ fontSize: "18px",textDecoration:"none", cursor: "pointer", }}>Login With Accounts</Link>
                    </div> */}
                </div>
